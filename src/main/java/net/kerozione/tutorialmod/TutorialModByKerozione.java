...
@Mod(TutorialModByKerozione.MOD_ID)
public class TutorialModByKerozione {
    public static final String MOD_ID = "tutorialmodbykerozione";
    private static final Logger LOGGER = LogUtils.getLogger();

    public TutorialModByKerozione(FMLJavaModLoadingContext context) {
